...
#if defined(BRCM_A2DP_DEFAULT_SAMPLERATE_48000)
#define A2DP_DEFAULT_SAMPLERATE         48000
#elif defined(BRCM_A2DP_DEFAULT_SAMPLERATE_44100) 
#define A2DP_DEFAULT_SAMPLERATE         44100
#else
#define A2DP_DEFAULT_SAMPLERATE         44100
#endif
...
static int _out_init_locked(struct astream_out *out, const char *addr)
{
    ...
    ret = a2dp_init(A2DP_DEFAULT_SAMPLERATE, 2, &out->data);
    if (ret < 0) {
...
#endif
{
    ...
    out->sample_rate = A2DP_DEFAULT_SAMPLERATE;
